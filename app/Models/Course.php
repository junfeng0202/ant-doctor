...
class Course extends Model
{
	...
	protected $fillable = ['hits', 'title', 'disease_id', 'image', 'brief', 'sort', 'enable', 'audio_count', 'havesection', 'price', 'active_price', 'active_on', 'active_start_at', 'active_end_at', 'sold'];
